...
Citizen.CreateThread(function()
  AddTextEntry('FE_THDR_GTAO', 'FlowRP')
end)
...
RegisterCommand('hud', function(source, args, rawCommand)
  ...
  if not showhud then
    state = 'off'
    exports['sw_alert']:showAlert('Zapnut HUD', 'green')
  else
    exports['sw_alert']:showAlert('Vypnut HUD', 'red')
  end
  print(state)
  ToggleNews(state)
end, false)
...
Citizen.CreateThread(function()
  while true do
    ...
    if planeLowFuel then
      --exports['sw_alert']:showAlert('Dochází ti palivo', 'red')
      Citizen.Wait(60000)
    end
    planeLowFuel = false
  end
